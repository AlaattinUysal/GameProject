...
class Canavar(pygame.sprite.Sprite):
    def __init__(self, idle_spritesheet, walk_spritesheet, 
                hurt_spritesheet, death_spritesheet,jump_spritesheet,attack1_spritesheet, attack2_spritesheet, attack3_spritesheet, x, y, speed):
        ...
        # Animasyonlar
        self.idle_frames = idle_spritesheet.get_animation_frames(128,128)
        self.walk_frames = walk_spritesheet.get_animation_frames(128,128)
        self.attack1_frames = attack1_spritesheet.get_animation_frames(128,128)
        self.attack2_frames = attack2_spritesheet.get_animation_frames(128,128)
        self.attack3_frames = attack3_spritesheet.get_animation_frames(128,128)
        self.hurt_frames = hurt_spritesheet.get_animation_frames(128,128)
        self.death_frames = death_spritesheet.get_animation_frames(128,128)
        self.jump_frames = jump_spritesheet.get_animation_frames(128,128)
