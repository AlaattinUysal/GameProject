...
parallax_factors_x = {}
parallax_factors_y = {}
hit_sound = pygame.mixer.Sound("sounds/punch_sound.wav")
...
class HealthPotion(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("assets/menu_tasarim/2 Bars/Healthbar_full.png").convert_alpha()  # İksir görseli
...
class Samurai(pygame.sprite.Sprite):
    ...
    def collect_potion(self):
        ...
        potion_sound = pygame.mixer.Sound("sounds/potion_sound.wav")
    ...
    def handle_input(self):
        ...
        # ESC tuşuna basıldığında menüye dön
...
class Arrow(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, direction, speed=8):
        ...
        if Arrow.hit_sound is None:
            Arrow.hit_sound = pygame.mixer.Sound("sounds/arrow_sound.wav")  # Ok vuruş sesi
...
ninja_hurt_spritesheet = Spritesheet("ENEMIES/Ninja_Monk/Hurt_Monk.png")
ninja_death_spritesheet = Spritesheet("ENEMIES/Ninja_Monk/Dead_Monk.png")

# Ninja Monk spritesheet'lerini yükle
ninja_idle_spritesheet = Spritesheet("ENEMIES/Ninja_Monk/Idle_Monk.png")
ninja_walk_spritesheet = Spritesheet("ENEMIES/Ninja_Monk/Walk_Monk.png")
ninja_attack_spritesheet = Spritesheet("ENEMIES/Ninja_Monk/Attack_1_Monk.png")
ninja_jump_spritesheet = Spritesheet("ENEMIES/Ninja_Monk/Jump_Monk.png")
