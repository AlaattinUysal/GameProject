...
<tileset version="1.10" tiledversion="1.11.2" name="health" tilewidth="48" tileheight="48" tilecount="9" columns="3">
 <image source="health/health 48x48.png" width="144" height="144"/>
 <tile id="0">
  <animation>
